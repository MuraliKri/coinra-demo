...
import ApprovalRequests from "./pages/procurement/ApprovalRequests";
  ...
  return (
    <DashboardLayout>
      <Switch>
        ...
        <Route path="/procurement" component={PurchaseOrders} />
        <Route path="/procurement/create" component={CreatePO} />
        <Route path="/procurement/approvals" component={ApprovalRequests} />
        <Route path="/procurement/:id" component={PODetail} />
